...
function refreshPageLanguage(){
  ...
  document.getElementById("rendelj-p").innerText = "Woltról vagy Foodoraról rendelsz. Ugyanaz a friss íz érkezik."
  ...
  document.getElementById("rendelj-p").innerText = "Order from Wolt or Foodora. Fresh food always arrives to you fast."
